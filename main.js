...
function my_keydowncar2(e)
{
	...
	console.log(keyPressed);
		...
		{
			car2_up();
			console.log("u alphabet key");
		}
		if(keyPressed == '68')
		{
			car2_down();
			console.log("d alphabet key");
		}
		if(keyPressed == '76')
		{
			car2_left();
			console.log("l alphabet key");
		}
		if(keyPressed == '82')
		{
			car2_right();
			console.log("r alphabet key");
		}
}
...
function car2_down()
{
	...
	{
		car2_y = car2_y+ 10;
		console.log("When d alphabet is pressed,  x = " + car2_x + " | y = " + car2_y);
		uploadBackground();
		 uploadcar2();
	}
}
function car2_left()
{
	...
	{
		car2_x = car2_x - 10;
		console.log("When l alphabet is pressed,  x = " + car2_x + " | y = " +car2_y);
		uploadBackground();
		 uploadcar2();
	}
}
function car2_right()
{
	...
	{
		car2_x =car2_x + 10;
		console.log("When r alphabet is pressed,  x = " + car2_x + " | y = " +car2_y);
		uploadBackground();
		uploadcar2();
   }
}
